...
print("The sum of the diagonal elements of the 3x3 matrix is: ",sum_diagonal_3x3)
...
print("The sum of the diagonal elements of the 4x4 matrix is: " , sum_diagonal_4x4)
